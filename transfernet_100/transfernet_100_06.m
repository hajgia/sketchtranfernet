function [net, info] = transfernet_100_06(varargin)
...
load('E:\刘杨\transfernet_100\data\sketch-baseline-alex-只调整fc-卷积参数0.01和0.01 加入feature-error\net-epoch-36.mat');
% Layers = {} ;
% %-----------------------------------------------
% Layers{1}.type = 'conv' ;
...
[net, info] = cnn_train_100_06(net, imdb1, imdb2, imdb3, imdb4, imdb5, @getBatch, ...
    opts.train) ;
