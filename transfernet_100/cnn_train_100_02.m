function [net, info] = cnn_train_100_02(net, imdb1, imdb2, imdb3, imdb4, imdb5, getBatch, varargin)
...
for i=1:numel(net.layers)
  if ~strcmp(net.layers{i}.type,'conv') || i==1 , continue; end
...
for epoch=1:opts.numEpochs
  ...
  if prevLr ~= lr
    ...
    for l=1:numel(net.layers)
      if ~strcmp(net.layers{l}.type, 'conv') || l==1 , continue ; end
  ...
  for t=1:opts.batchSize:numel(train)
    ...
    res = vl_simplenn_100_02(net, im, one, res, ...
  ...
  for t=1:opts.batchSize:numel(val)
    ...
    net.layers{end}.class = labels ;
    res = vl_simplenn_100_02(net, im, [], res, ...
      'disableDropout', true, ...
      'conserveMemory', opts.conserveMemory, ...
      'sync', opts.sync) ;
