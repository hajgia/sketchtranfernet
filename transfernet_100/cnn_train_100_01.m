function [net, info] = cnn_train_100_01(net, imdb1, imdb2, imdb3, imdb4, imdb5, getBatch, varargin)
...
for epoch=1:opts.numEpochs
  ...
  for t=1:opts.batchSize:numel(train)
    ...
    res = vl_simplenn_100_01(net, im, one, res, ...
  ...
  for t=1:opts.batchSize:numel(val)
    ...
    net.layers{end}.class = labels ;
    res = vl_simplenn_100_01(net, im, [], res, ...
      'disableDropout', true, ...
      'conserveMemory', opts.conserveMemory, ...
      'sync', opts.sync) ;
