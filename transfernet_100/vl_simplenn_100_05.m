function res = vl_simplenn_100_05(net, x, dzdy, res, error, varargin)
...
for i=1:n
  ...
  switch l.type
    ...
    case 'softmaxloss'
      res(i+1).x = vl_nnsoftmaxloss_piuserror(res(i).x, l.class ,error) ;
    case 'relu'
