function [net, info] = transfernet_100(varargin)
...
net.layers{end+1} = struct('type', 'conv', ...                  %16
                           'filters', 0.1 * randn(1,1,4096,2048,'single'),...
...
net.layers{end+1} = struct('type', 'conv', ...       %19
                           'filters', 0.1 * randn(1,1,2048,250,'single'),...
...
[net, info] = cnn_train_100(net, imdb1, imdb2, imdb3, imdb4, imdb5, @getBatch, ...
    opts.train) ;
